...
def create_distance_matrix_sq(region_nc):
    ...
    for artist1 in region_nc:
        ...
        for artist2 in region_nc:
            region_nc_artist1=reorder(artist1[1:])
            region_nc_artist2=reorder(artist2[1:])
...
if __name__ == "__main__":
    ...
    #filename = "../REPORT_AVG_REGIONAL_COMPLEXITY_PER_BLOCK"
    ...
    # set_period_artist_color("t_nj_256_cosine",tree_period_nj, period_color,st,authors,im, basename)
    # set_date_artist_color("t_nj_256_cosine",tree_date_nj, artist_period, date_color)
