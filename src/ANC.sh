...
if [[ "$RUN_PLOT" -eq "1" ]]; then
  ...
  plot 'NC_AVERAGE' using 3:xtic(1) title 'Number of images' with boxes lc rgb '#396AB1' linetype 2 axes x1y2, 'NC_AVERAGE' using 2:xtic(1) title 'Average NC' with boxes lc rgb '#cc0000' linetype 1 axes x1y1," | gnuplot -p
fi
#
# ==============================================================================
~                                                                                          
